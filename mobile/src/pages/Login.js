    ...
    return (
      <KeyboardAvoidingView style={styles.container} behavior="padding">
        <View style={styles.content}>
          <View>{//para que o icone suba deslizando quando abre o teclado
          }
          ...
          />
          {/*returnKeyType: Muda o tipo do botão retornar do teclado para submit*/}
          {/*onSubmitEditing: Passa o evento do botão return */}
